...
// node_modules/tdesign-miniprogram/miniprogram_dist/qrcode/components/qrcode-status/qrcode-status.js
var qrcode_status_exports = {};
__export(qrcode_status_exports, {
  default: () => qrcode_status_default
});
module.exports = __toCommonJS(qrcode_status_exports);
...
// node_modules/tdesign-miniprogram/miniprogram_dist/qrcode/components/qrcode-status/props.js
var props_default = { status: { type: String, value: "" }, locale: { type: Object, value: { expiredText: "二维码过期", refreshText: "点击刷新", scannedText: "已扫描" } }, statusRender: { type: Boolean, value: false } };
...
// node_modules/tdesign-miniprogram/miniprogram_dist/qrcode/components/qrcode-status/qrcode-status.js
var { prefix: prefix2 } = config_default, name = `${prefix2}-qrcode`;
var QRCode = class extends SuperComponent {
  constructor() {
    super(...arguments), this.options = { multipleSlots: true }, this.properties = Object.assign(Object.assign({}, props_default), { statusRender: { type: Boolean, value: false } }), this.data = { prefix: prefix2, classPrefix: name, isSkyline: false }, this.lifetimes = { attached() {
      this.setData({ isSkyline: "skyline" === this.renderer });
    } }, this.methods = { handleRefresh() {
      this.triggerEvent("refresh");
    } };
  }
};
QRCode = __decorate([wxComponent()], QRCode);
var qrcode_status_default = QRCode;
