...
// node_modules/tdesign-miniprogram/miniprogram_dist/sticky/index.js
var index_exports = {};
module.exports = __toCommonJS(index_exports);

// node_modules/tdesign-miniprogram/miniprogram_dist/sticky/props.js
var props = { container: { type: null }, disabled: { type: Boolean, value: false }, offsetTop: { type: null, value: 0 }, zIndex: { type: Number, value: 99 } };
...
var page_scroll_default = (r = "onScroll") => Behavior({ attached() {
  var e;
...
var { prefix: prefix2 } = config_default, name = `${prefix2}-sticky`, ContainerClass = `.${name}`;
var Sticky = class extends SuperComponent {
  constructor() {
    super(...arguments), this.externalClasses = [`${prefix2}-class`, `${prefix2}-class-content`], this.properties = props_default, this.behaviors = [page_scroll_default()], this.observers = { "offsetTop, disabled, container"() {
      this.onScroll();
    } }, this.data = { prefix: prefix2, classPrefix: name, containerStyle: "", contentStyle: "" }, this.methods = { onScroll(t) {
      const { scrollTop: e } = t || {}, { container: i, offsetTop: o, disabled: s } = this.properties;
      s ? this.setDataAfterDiff({ isFixed: false, transform: 0 }) : (this.scrollTop = e || this.scrollTop, "function" != typeof i ? getRect(this, ContainerClass).then((t2) => {
        t2 && (o >= t2.top ? (this.setDataAfterDiff({ isFixed: true, height: t2.height }), this.transform = 0) : this.setDataAfterDiff({ isFixed: false }));
      }) : Promise.all([getRect(this, ContainerClass), this.getContainerRect()]).then(([t2, e2]) => {
