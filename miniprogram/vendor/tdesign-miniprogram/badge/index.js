...
// node_modules/tdesign-miniprogram/miniprogram_dist/badge/index.js
var index_exports = {};
...
var { prefix: prefix2 } = config_default, name = `${prefix2}-badge`, getUniqueID = uniqueFactory("badge");
var Badge = class extends SuperComponent {
  constructor() {
    super(...arguments), this.options = { multipleSlots: true }, this.externalClasses = [`${prefix2}-class`, `${prefix2}-class-count`, `${prefix2}-class-content`], this.properties = props_default, this.data = { prefix: prefix2, classPrefix: name, value: "", labelID: "", descriptionID: "", useOuterClass: false }, this.lifetimes = { ready() {
      const e = getUniqueID();
      this.setData({ labelID: `${e}_label`, descriptionID: `${e}_description` }), this.checkForActualContent();
    } }, this.methods = { checkForActualContent() {
      if (!this.properties.content && ["ribbon", "ribbon-right", "ribbon-left", "triangle-right", "triangle-left"].includes(this.properties.shape)) return getRect(this, `.${name}__content`).then((e) => {
