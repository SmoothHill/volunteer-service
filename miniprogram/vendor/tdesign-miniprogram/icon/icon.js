...
var props = { color: { type: String, value: "" }, name: { type: String, value: "", required: true }, prefix: { type: String, value: "" }, size: { type: null } };
...
// node_modules/tdesign-miniprogram/miniprogram_dist/icon/icon.js
var { prefix: prefix2 } = config_default, name = `${prefix2}-icon`;
var Icon = class extends SuperComponent {
  constructor() {
    super(...arguments), this.externalClasses = [`${prefix2}-class`], this.properties = props_default, this.data = { componentPrefix: prefix2, classPrefix: name, isImage: false, iconStyle: void 0 }, this.observers = { "name, color, size, style"() {
      this.setIconStyle();
    } }, this.methods = { onTap(t) {
      this.triggerEvent("click", t.detail);
    }, setIconStyle() {
      const { name: t, color: e, size: o, classPrefix: i } = this.data, s = -1 !== t.indexOf("/"), n = null !== o && "" !== o ? addUnit(o) : void 0, r = e ? { color: e } : {}, c = o ? { "font-size": n } : {}, a = Object.assign(Object.assign({}, r), c);
      this.setData({ isImage: s }, () => __awaiter(this, void 0, void 0, function* () {
        if (s) {
          let t2 = n;
          t2 || (yield getRect(this, `.${i}`).then((e2) => {
            t2 = addUnit(null == e2 ? void 0 : e2.height);
          }).catch(() => {
          })), a.width = t2, a.height = t2;
        }
        this.setData({ iconStyle: `${styles(a)}` });
      }));
    } };
  }
};
